...
- **Prawy klik na osobie** = menu **Invite / Whisper**; **Kick** gdy jest w Twojej grupie i jesteś liderem/asystentem.
...
- **Prawy klik na nicku w czacie** → Blizzardowe menu z dodatkową pozycją **„Invite to guild"** (gdy masz w grze uprawnienia do zapraszania).
